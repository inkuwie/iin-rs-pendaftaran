...
if(isset($_POST["post"]) ) {
  ...
  if(tambah_poli($_POST) > 0 ) {
    echo "<script>
              alert('poliklinik baru telah ditambahkan!');
      ...
      <div class="container-fluid">
        ...
        <div class="col mt-1">
          <table class="table table-sm table-borderless">
            <tr>
              <td width="450" rowspan="2"><h5 class="">Tambah Poli Rawat Jalan</h5></td>
            </tr>
        ...
        <div class="row">
                <div class="col md">
                  <form class="" action="" method="post">
                    ...
                    <div class="col-sm-3">
                    <input type="text" class="form-control" id="nama_poli" name="nama_poli" required autocomplete="off">
