...
$jadwal_dokter = query("SELECT jam.id_jam,dokter.id_dokter,dokter.nama_dokter,poliklinik.nama_poli,jam.jam from jam    join poliklinik on jam.id_poli=poliklinik.id_poli   join dokter on jam.id_dokter=dokter.id_dokter ORDER BY nama_poli ASC");
                        ...
                        <?php  foreach ($jadwal_dokter as $row ) : ?>
                             ...
                             <tr>
                               ...
                               <td>
                                     ...
                                     <button type="button" class="btn btn-outline-info btn-sm mt-1"><a href="hapus_dokter.php?id_jam=<?= $row["id_jam"]?>" class="text-reset" onclick=" return confirm('Anda Yakin?');" style="text-decoration:none">Hapus</a></button>
                               </td>
                             </tr>
                             <?php $i++ ?>
                           <?php endforeach; ?>
