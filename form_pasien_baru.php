                    ...
                    <form class="" action="" method="post">
                      <div class="row">
                        ...
                        <div class="col">
                          ...
                          <input type="text" class="form-control" id="nama" name="nama" autocomplete="off" value="" placeholder="" >
                          </div>
                          ...
                          <select class="form-control" name="jk" id="jk" >
                            ...
                            <option value="pria">Pria</option>
                                      ...
                                      <div class="row">
                                        ...
                                        <input type="text" class="form-control" id="nohp" name="nohp" autocomplete="off" value="" placeholder="" >
                                        </div>
                                        </div>
                                        ...
                                        <input type="date" class="form-control" id="ttl" name="ttl" autocomplete="off" value="" >
                                        </div>

                                        <div class="form-group">
                                        <label for="">Pekerjaan</label>
                                        <input type="text" class="form-control" id="pekerjaan" name="pekerjaan" autocomplete="off" value="" placeholder="" >
                                        </div>
                                        </div>
                                        </div>
                        ...
                        <div class="col">
                          ...
                          <input type="text" class="form-control" id="wnama" name="wnama" autocomplete="off" value="" placeholder="" >
                          </div>
                          ...
                          <input type="text" class="form-control" id="wnohp" name="wnohp" autocomplete="off" value="" placeholder="" >
                          </div>
