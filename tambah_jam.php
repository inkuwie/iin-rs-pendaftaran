      ...
      <div class="container-fluid">
        ...
        <div class="col mt-1">
          <table class="table table-sm table-borderless">
            <tr>
              <td width="450" rowspan="2"><h5 class="">Tambah Jam Praktek Rawat Jalan</h5></td>
            </tr>
                ...
                <div class="col md">
                  <form class="" action="" method="post">
                    <div class="form-group">
                      <div class="col-sm-4">
                    <input type="hidden" class="form-control" id="id_jam" name="id_jam" value="">
                    <label for="nama">Jam Praktek</label>
                    <input type="text" class="form-control" id="jam" name="jam" value="" autocomplete="off">
                    </div>
                  </div>
                    ...
                    <div class="form-group">
                      ...
                      <label for="">Nama Dokter</label>
                        <?php
                          $query = $db->query("SELECT * FROM dokter WHERE status = 1 ORDER BY nama_dokter ASC");
                        ...
                        <select class="form-control" name="dokter" id="dokter">
                          ...
                          if($rowCount > 0){
                            ...
                            echo'<option value="">dokter not available</option>';
                          }
                           ?>
                      </select>
