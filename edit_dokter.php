...
$jadwal_dokter = query("SELECT jam.id_jam,dokter.nama_dokter,poliklinik.nama_poli,jam.jam from jam   join poliklinik on jam.id_poli=poliklinik.id_poli    join dokter on jam.id_dokter=dokter.id_dokter where id_jam = $id_jam")[0];
